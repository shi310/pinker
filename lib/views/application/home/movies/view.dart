...
class HomeMoviesViewView extends StatelessWidget {
  const HomeMoviesViewView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<HomeMoviesViewController>(
      init: HomeMoviesViewController(),
      builder: (controller) {
        /// 背景部分
